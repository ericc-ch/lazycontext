...
- [ ] **Integration**
  - [x] Update `src/main.tsx` to mount the application.
  - [x] Implement main App layout with RepoList, InputBar, and StatusBar.
  - [x] Wire up "Add Repo" flow from UI to ConfigService.
